...
class MainMenuScreen : public Screen {
  ...
  private:
    static const int BACK = 0, ALARM1 = 1, ALARM2 = 2, ALARM3 = 3, SET_TIME = 4;
    static const int MENU_ENTRY_COUNT = 5;
    const struct DisplayData menuText[MENU_ENTRY_COUNT] = {{{c['B'], c['a'], c['c'], c['k'], 0x00, 0x00}}, {{c['A'], c['l'], c['a'], c['r'], c['m'], c[1]}}, {{c['A'], c['l'], c['a'], c['r'], c['m'], c[2]}}, {{c['A'], c['l'], c['a'], c['r'], c['m'], c[3]}}, {{c['T'], c['i'], c['m'], c['e'], 0x00, 0x00}}};
